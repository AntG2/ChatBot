...
def tag_conversation(question):
    ...
    response = openai.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"生成以下问题的关键词，突出主要主题：'{question}'. Do not extract keywords from my prompt, only the question. Keep keywords concise. Ignore meaningless words in text like 吗,是, like."}
        ]
    )
